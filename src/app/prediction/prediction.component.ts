...
export class PredictionComponent implements OnInit {
  ...
  predictTopPlayers() {
    this.players.forEach(player => {
      player.predictedRuns = this.weightedAverage(
        player.runs,
        this.recentMatchCount,
        this.recentWeight,
        this.olderWeight
      );
      player.predictedWickets = this.weightedAverage(
        player.wickets,
        this.recentMatchCount,
        this.recentWeight,
        this.olderWeight
      );
      player.predictedStrikeRate = this.weightedAverage(
        player.strikeRate,
        this.recentMatchCount,
        this.recentWeight,
        this.olderWeight
  ...
  predictTopTeams() {
    ...
    this.topTeams = Object.entries(teamPerformanceMap).map(
      ([teamName, totalPerformanceScore]) => {
